...
const lines = [
  ...
  `| Static first-level Zhuyin symbols | ${analysis.staticZhuyinSymbolCount} | Visible without continuation |`,
  `| Dynamic continuation Zhuyin symbols | ${analysis.dynamicZhuyinSymbolCount} | Hidden first-level symbols that can appear as continuations |`,
