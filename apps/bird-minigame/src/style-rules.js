export function validatePixelStyle(style) {
  ...
  range('grid.minimumHeight',200,500,true); range('grid.maximumHeight',240,800,true);
  ...
  for(const [key,min,max,integer] of [['count',1,10,true],['sizeVariation',0,0.35,false],['puffiness',0.8,2.2,false],['baseHeight',0.65,1,false]]) {
