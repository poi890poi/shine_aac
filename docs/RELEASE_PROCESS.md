...
```text
.artifacts\releases\v0.3.3\shine-aac-v0.3.3-code57-debug.apk
...
```text
.artifacts\releases\v0.3.3\shine-aac-v0.3.3-code57-release.apk
.artifacts\releases\v0.3.3\RELEASE_APK_SHA256SUMS.txt
.artifacts\releases\v0.3.3\shine-aac-v0.3.3-code57-release.aab
