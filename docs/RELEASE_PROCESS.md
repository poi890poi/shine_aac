...
```text
.artifacts\releases\v0.3.4\shine-aac-v0.3.4-code56-debug.apk
...
```text
.artifacts\releases\v0.3.4\shine-aac-v0.3.4-code56-release.apk
.artifacts\releases\v0.3.4\RELEASE_APK_SHA256SUMS.txt
.artifacts\releases\v0.3.4\shine-aac-v0.3.4-code56-release.aab
