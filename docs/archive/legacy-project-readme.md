...
> Historical long-form root README preserved during the v0.4.1 documentation cleanup.
...
- [User Guide (zh-TW)](../index.html)
- [Camera Gesture Switch Guide (zh-TW)](../camera-switch/index.html)
- [Advanced Scanning and Settings Guide (zh-TW)](../advanced-settings/index.html)
- [AAC Core](../../packages/aac-core/README.md)
- [Testing Report](../TESTING_REPORT.md)
- [Text And Display Scaling Policy](../TEXT_SCALING_POLICY.md)
- [Windows/Browser App Report](../WINDOWS_APP_REPORT.md)
- [Play Internal Testing Report](../PLAY_INTERNAL_TESTING_REPORT.md)
- [Side-load APK Report](../APK_REPORT.md)
- [Alternative Input Survey](../ALTERNATIVE_INPUT_SURVEY.md)
- [Input Adapters](../INPUT_ADAPTERS.md)
- [Multilingual Design](../MULTILINGUAL_DESIGN.md)
...
[Traditional Chinese operation guide](../index.html#speech-setup).
...
[offline resource management guide](../OFFLINE_RESOURCES.md) for integrity,
...
See the dedicated [USB UVC camera guide](../uvc-camera/index.html) for
